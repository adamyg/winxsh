#!/usr/bin/perl -w
# -*- mode: perl; -*-
# $Id: buildinfo.pl,v 1.1 2020/06/08 21:02:46 cvsuser Exp $
...
#define ${prefix}PACKAGE_NAME "${name}"
...
#define ${prefix}BUILD_DATE "${date}"
#define ${prefix}BUILD_NUMBER "${build}"
EOT
	...
	print FILE "#define ${prefix}BUILD_TOOLCHAIN \"${toolchain}\"\n"
		if ($toolchain);
